...
const addPost=()=>{
        ...
        axios.post(`https://terakarachi.com/api/bookingpostdata`,{
...
const fetchFlat = async () => {
  const res = await fetch('https://terakarachi.com/api/flatid/6349c7e9d21e304d9e00a547');
...
const fetchWeight = async () => {
  const res = await fetch('https://terakarachi.com/api/weightid/636522f618af3a1d34c3e90d');
  const data = await res.json();
