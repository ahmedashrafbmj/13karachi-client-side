...
const addPost=()=>{
        ...
        axios.post(`http://18.191.246.31:9000/api/bookingpostdata`,{
...
const fetchFlat = async () => {
  const res = await fetch('http://18.191.246.31:9000/api/flatid/6349c7e9d21e304d9e00a547');
...
const fetchWeight = async () => {
  const res = await fetch('http://18.191.246.31:9000/api/weightid/636522f618af3a1d34c3e90d');
  const data = await res.json();
