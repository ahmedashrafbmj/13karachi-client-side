...
const getdata = async () => {
    ...
    // http://18.191.246.31:9000/api/allpostdata
...
const updatePost=(id)=>{
        ...
        axios.patch(`http://18.191.246.31:9000/api/carouselupdate/${id}`,{
...
const deletedata = async (id) => {
    ...
    const res2 = await fetch(`http://18.191.246.31:9000/api/deletecarousel/${id}`, {
        method: "DELETE",
        headers: {
            "Content-Type": "application/json"
        }
